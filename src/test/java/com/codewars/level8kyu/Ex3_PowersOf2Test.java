...
public class Ex3_PowersOf2Test {
  ...
  public void testSomething() {
    ...
    assertArrayEquals(new long[] { 1 }, Ex3_PowersOf2.powersOfTwo(0));

    // Lo mismo con otras pruebas
    assertArrayEquals(new long[] { 1, 2 }, Ex3_PowersOf2.powersOfTwo(1));
    assertArrayEquals(new long[] { 1, 2, 4, 8, 16 }, Ex3_PowersOf2.powersOfTwo(4));
  }
